...
% Title
\title{Search for \lowercase{$t\bar{t}$} resonances in the all-hadronic channel with the CMS Detector using 138 \lowercase{fb$^{-1}$} of data from \lowercase{pp} collisions at \lowercase{$\sqrt{s} = 13.6$} T\lowercase{e}V.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
\include{appendix_kinematics}
\include{appendix_2dalphabet}
\include{appendix_systematics}
\include{appendix_limits}
